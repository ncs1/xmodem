...
Gem::Specification.new do |spec|
  ...
  spec.summary       = 'A pure XMODEM implementation in Ruby for sender and receiver. Compatible with Ruby 2.6+'
  spec.description   = 'A simple gem for XMODEM client and server application. Forked from modem_protocols and made to work with newer Rubies. Today the XMODEM protocol is widely used in embedded systems for OTA application firmware transfer.'
